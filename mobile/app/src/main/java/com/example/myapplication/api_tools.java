...
public class api_tools {
    public void login(final Activity activity, final String username, final String password) {
        ...
        //创建一个请求
        String url = "http://192.168.10.75:8010/guard/user/login";
        ...
        final SharedPreferences sharedPreferences = activity.getSharedPreferences("User", MODE_PRIVATE);
            final SharedPreferences.Editor editor = sharedPreferences.edit();
        //创建一个请求
        String url="http://192.168.10.75:8010/guard/user/update";
    ...
    public void updateRole(final Activity activity, final Map<String,String> newRoleMap) {
        //创建一个请求队列
        RequestQueue requestQueue= Volley.newRequestQueue(activity);
        final SharedPreferences sharedPreferences = activity.getSharedPreferences("User", MODE_PRIVATE);
        final SharedPreferences.Editor editor = sharedPreferences.edit();
        //创建一个请求
        String url="http://192.168.10.75:8010/guard/role/update";
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                JSONObject user = JSON.parseObject(s);
