                ...
                if (username.isEmpty()|| tel.isEmpty()|| email.isEmpty() || name.isEmpty() || pwd1.isEmpty() || pwd2.isEmpty())
                    ...
                    if (Code.isEmpty())
                        ...
                        if (!pwd1.equals(pwd2)) {
                            ...
                            String url="http://192.168.1.100:8010/guard/user/add";
                           ...
                           /* stringRequest.setRetryPolicy(new RetryPolicy(){
                            ...
                            /*UserService userService=new UserService(RegActivity.this);
                            User user=new User();
                            user.setUsername(username);
                            user.setUserpwd(Integer.parseInt(pwd1));
                            ...
                            if (result == 1) {
                                ...
                                Toast.makeText(RegActivity.this, "！", Toast.LENGTH_SHORT).show();
                            }*/
                        }
                    }
                }
